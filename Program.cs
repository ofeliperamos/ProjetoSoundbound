...
bandasRegistradas.Add("ACDC", new List<int> {10,8,9,5 });
...
{
    Console.Clear();
    ExibirTitulosDaOpcao("Exibindo todas as bandas registradas na nossa aplicação");
    Console.WriteLine("**********************");
   ...
   // }
    ...
    Console.WriteLine("\nDigite uma Tecla para o Retorno");
    Console.ReadKey();
    Console.Clear();
    ExibirOpcoesDoMenu();
}
...
void AvaliarUmaBanda()
{
    ...
    // Se a a banda existir no dicionario >> atribuir uma nota 
...
void ExibirMedia()
{
    ...
    if (bandasRegistradas.ContainsKey (nomeDaBanda)) 
    {
        ...
        Console.WriteLine($"notasDaBandas {nomeDaBanda} é {notasDaBanda.Average()}.");
        Console.WriteLine("Digite uma tecla para voltar ao menu principal");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
